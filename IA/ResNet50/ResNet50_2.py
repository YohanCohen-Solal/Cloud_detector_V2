...
checkpoint = ModelCheckpoint("resnet50_model2.h5", monitor='accuracy', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
...
plt.savefig('accuracy2_curves_res.png')
plt.show()
...
plt.savefig('loss2_curves_res.png')
plt.show()
