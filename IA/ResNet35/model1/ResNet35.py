...
checkpoint = ModelCheckpoint("resnet35_model1.h5", monitor='accuracy', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
...
plt.savefig('accuracy1_res35.png')
